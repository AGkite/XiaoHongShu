<template>
    ...
    <div v-show="showScrollToTopBtn" @click="scrollToTop" class="border cursor-pointer fixed bottom-2 right-2 md:bottom-10 md:right-10 inline p-3 bg-white hover:bg-gray-100 rounded">
